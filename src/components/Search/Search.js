...
const Search = (props) => {
    ...
    return (
        <div className="w-full">
            ...
            <div className="pt-7 display-flex  justify-center align-center text-center">
                ...
                <form onSubmit={() => { navigate('/searching/?h') }} className="pl-15 bg-blue pt-12 align-center w-1/2">
                    ...
                    <div className="justify-center relative">
                        ...
                        <input type="search" id="default-search" className="block font-bold text-2xl p-4 pl-10 w-full text-m text-white bg-[#3730A3] rounded-full focus:ring-blue-500  dark:bg-gray-700  dark:placeholder-white dark:text-white dark:focus:ring-blue-500" placeholder={props.search} required />
                    </div>
                    {display}
                </form>
