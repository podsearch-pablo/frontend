...
import ScrunchList from "../Result/ScrunchList";
...
const DynamicSearch = () => {
    ...
    useEffect(() => {
        ...
        for (let a = 0; a < listItems.length; a++) {
            ...
            ans.push(
                <div className="col-span-4 pt-16">
                    ...
                    <div className="flex justify-center">
                        <ImageResult2 id={String(searchDict.indexOf(listItems[a + 2]))} />
                    </div>
                </div>);
            ...
            console.log(listItems[a + 2]);
            console.log("THAT WAS IT");
            console.log(uploadDict['The business of filming your daily life (ur mom ashley interview)']);
            console.log(uploadDict[listItems[a + 2]]);
    ...
    }, [listItems, searchDict, uploadDict]);
            ...
            .then(function (data) {
                ...
                if (data.length === 0) {
                    ...
                    for (let x = 0; x < dict.length; x++) {
                        ...
                        lst.push(
                            <ScrunchList search={searchTerm} dictionary={dict[x]['Clips']} />
